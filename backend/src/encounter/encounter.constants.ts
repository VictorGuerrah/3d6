...
export const THREAT_POINTS_TARGET_TABLE: Record<number, Record<EncounterDifficulty, number>> = {
  2: {
    [EncounterDifficulty.Easy]: 2,
    [EncounterDifficulty.Medium]: 4,
    [EncounterDifficulty.Hard]: 6,
    [EncounterDifficulty.Epic]: 12,
  },
  3: {
    [EncounterDifficulty.Easy]: 3,
    [EncounterDifficulty.Medium]: 6,
    [EncounterDifficulty.Hard]: 9,
    [EncounterDifficulty.Epic]: 12,
  },
  4: {
    [EncounterDifficulty.Easy]: 4,
    [EncounterDifficulty.Medium]: 8,
    [EncounterDifficulty.Hard]: 12,
    [EncounterDifficulty.Epic]: 16,
  },
  5: {
    [EncounterDifficulty.Easy]: 5,
    [EncounterDifficulty.Medium]: 10,
    [EncounterDifficulty.Hard]: 15,
    [EncounterDifficulty.Epic]: 20,
  },
};
